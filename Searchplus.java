...
//		System.out.println(tableforkstate);
		for(Object s:tableforkstate)
		{
			...
			{
			case 1:			g4.drawString("ψ",800,300);break;
			case 2:			g4.drawString("ψ",850,450);break;
			case 3:			g4.drawString("ψ",700,600);break;
			case 4:			g4.drawString("ψ",600,450);break;
			case 5:			g4.drawString("ψ",650,300);break;
			}
		}
